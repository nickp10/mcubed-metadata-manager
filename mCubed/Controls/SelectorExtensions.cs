...
namespace mCubed.Controls
{
	public static class SelectorExtensions
	{
		...
		public static readonly DependencyProperty IsSelectableProperty =
			DependencyProperty.RegisterAttached("IsSelectable", typeof(bool), typeof(SelectorExtensions), new PropertyMetadata(true));
		...
		/// <param name="isSelectable">True to allow the item to be selected, or false if it cannot be selected.</param>
		...
		public static readonly DependencyProperty IsGridViewRowProperty =
			DependencyProperty.RegisterAttached("IsGridViewRow", typeof(bool), typeof(SelectorExtensions), new PropertyMetadata(true));
